...
class Message(object):
    ...
    +===============+=============+========+===============================================================+
    |  VERSION_DATA |      1      |  Reply | Data for version comparison between CPU and sensor            |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |  HEAD_DATA    |      2      | Reply  | The MSG reply in response to SEND_DATA commands               |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |  ALIVE        |      4      | Reply  | On power-up, the broadcast state of motor, transducer, params |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |  BB_USER_DATA |      6      | Reply  | Receive settings programmed                                   |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |   REBOOT      |      16     | Send   | Reboots device                                                |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |  HEAD_COMMAND |      19     | Send   | Update parameters                                             |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |  SEND_BB_USER |      24     | Send   | Program settings and options                                  |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |  SEND_VERSION |      23     | Send   | Request version                                               |
    +---------------+-------------+--------+---------------------------------------------------------------+
    |  SEND_DATA    |      25     | Send   | Perform sample set                                            |
    +---------------+-------------+--------+---------------------------------------------------------------+
